...
<context>
    ...
    <message>
        ...
        <translation>あなたのコンピュータでマイニングを行うことで、Kosonのネットワークをより強固にすることができます。マイニングをする人が増えるほど、ネットワークへの攻撃が難しくなります。一人一人の協力が大切です。&lt;br&gt; &lt;br&gt;マイニングをすると、低確率ですがKosonを獲得できる可能性があります。あなたのコンピュータは、ある計算問題の解となるブロックとそのハッシュ値を計算します。正解のブロックが見つかると、あなたはそれに伴う報酬を得ます。グッドラック!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Embedded Koson version: </source>
        <translation>埋め込まれたKosonのバージョン: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このページでは共有リングデータベースを操作できます。このデータベースはKosonウォレットおよびKosonのキーを再利用するKosonクローンのウォレットで利用するためのものです。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Kosonのリング署名による保護を無効化しないため、あるアウトプットを使う際に異なるブロックチェーンで異なるリングを使うことは避けなければなりません。これは通常問題になりませんが、キーを再利用するKosonクローンが既存のアウトプットの使用を許している場合問題になります。この場合、既存のアウトプットは両方のチェーンで同じリングを使わなくてはなりません。&lt;br&gt;これはキーを再利用するソフトウェアが積極的にプライバシーを侵害しようとしない限り自動的に行われます。&lt;br&gt;もしキーを再利用するKosonクローンを使っていてそのクローンがこの保護を含んでいない場合も、まずクローンの方でアウトプットを使用しその後リングをこのページに手動で追加することで、トランザクションは保護されKosonを安全に使用できるようになります。&lt;br&gt;これらの機能を提供しないキーを再利用するKosonクローンを使用していない場合、すべては自動化されているので何もする必要はありません。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>キーを再利用するチェーンでアウトプットに使用されたリングを記録し、プライバシーの問題を避けるためKosonでも同じリングを使うようにします。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>KSNの送金に成功しました</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>We’re almost there - let’s just configure some KSN preferences</source>
        <translation>あと少しで完了です - いくつかの項目を設定してください</translation>
    </message>
    <message>
        <location filename="../wizard/WizardConfigure.qml" line="97"/>
        <source>Kickstart the KSN blockchain?</source>
        <translation>KSNのブロックチェーンを初期化しますか？</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>ディスク容量節約モードを有効にすると、使用するディスク容量はずっと小さくなりますが、通信帯域の使用量は通常モードと変わりません。ただし、Kosonのネットワークの安全性を高める意味で、完全なブロックチェーンの全体を保存することが推奨されています。もしあなたのコンピュータのディスク容量が小さい場合は、このオプションを使用してください。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Kosonの採掘をすることでネットワークの安全性が高まり、また提供した計算量の対価として低い確率ですが報酬が得られます。このオプションは、あなたのコンピュータが電源に接続されていてなおかつアイドル状態の場合に、自動的にKosonの採掘を行うことを許可します。あなたが作業を再開すると、採掘は停止されます。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Kosonネットワークと通信するためにウォレットはKosonノードに接続されている必要があります。プライバシーを最大限に保護するため自分自身のノードを走らせることが推奨されています。
...
<context>
    ...
    <message>
        ...
        <translation>Kosonの開発は寄付のみによって支えられています</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>取引には少額の手数料がかかります。このオプションはその手数料に加えて、手数料の何パーセントかをKosonの開発チームへの寄付として支払うことを許可します。例えば自動寄付の割合が50%で、取引の手数料が0.005 XMRであった場合、0.0025 XMRが開発チームへの寄付として取引に上乗せされます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>KOSONを使う</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Kosonへようこそ!</translation>
    </message>
    <message>
...
金額: </translation>
    ...
    <message>
        ...
        <translation>新しいバージョンのkoson-wallet-guiを入手できます: %1&lt;br&gt;%2</translation>
    </message>
    <message>
...
手数料: </translation>
    ...
    <message>
        ...
        <translation>KSNの送金に成功しました: %1 トランザクション</translation>
    </message>
    <message>
