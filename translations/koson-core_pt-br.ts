...
<context>
    ...
    <message>
        ...
        <translation>Minerar com seu computador ajuda a fortalecer a rede do Koson. Quanto mais pessoas minerarem, mais difícil é para a rede ser atacada, qualquer quantidade ajuda. &lt;br&gt; &lt;br&gt;Minerar também lhe garante uma pequena chance de ganhar KSN. Seu computador irá criar hashes buscando por soluções aos blocos. Caso encontre um bloco, você receberá a recompensa associada. Boa sorte!</translation>
    </message>
    <message>
...
<message>
    ...
    <message>
        ...
        <translation>Sem KSN suficiente</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>This page allows you to interact with the shared ring database. This database is meant for use by Koson wallets as well as wallets from Koson clones which reuse the Koson keys.</source>
        <translation>Essa página te permite interagir com a base de dados compartilhada dos anéis. Essa base de dados serve para ser usada por carteiras Koson e outras carteiras de clones do Koson que reutilizam as mesmas chaves.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>In order to avoid nullifying the protection afforded by Koson&apos;s ring signatures, an output should not be spent with different rings on different blockchains. While this is normally not a concern, it can become one when a key-reusing Koson clone allows you do spend existing outputs. In this case, you need to ensure this existing outputs uses the same ring on both chains.&lt;br&gt;This will be done automatically by Koson and any key-reusing software which is not trying to actively strip you of your privacy.&lt;br&gt;If you are using a key-reusing Koson clone too, and this clone does not include this protection, you can still ensure your transactions are protected by spending on the clone first, then manually adding the ring on this page, which allows you to then spend your KSN safely.&lt;br&gt;If you do not use a key-reusing Koson clone without these safety features, then you do not need to do anything as it is all automated.&lt;br&gt;</source>
        <translation>Para evitar que a proteção das assinaturas em anel seja anulada, uma saída não pode ser utilizada em anéis diferentes em blockchains diferentes. Isso normalmente não é um problema, mas pode vir a se tornar um caso um clone do Koson que reutiliza as mesmas chaves te permita reutilizar essas saídas. Nesse caso, você precisa se assegurar que essas saídas utilizem o mesmo anel em ambos os blockchains.&lt;br&gt;Isso será feito automaticamente pelo Koson e qualquer outro software de reutilização de chaves que não esteja tentando danificar sua privacidade de forma arbitrária.&lt;br&gt;Se você também utiliza algum clone do Koson com as mesmas chaves, ainda é possível garantir que suas transações estão protegidas ao gastar suas saídas primeiramente no clone, e então adicionar o anel nessa página, que te permitirá usar seu Koson de forma segura.&lt;br&gt;Se você não utiliza um clone do Koson sem esses recursos de segurança, não é preciso fazer nada, pois tudo está automatizado.&lt;br&gt;</translation>
    </message>
    <message>
        <location filename="../pages/SharedRingDB.qml" line="267"/>
        <source>This records rings used by outputs spent on Koson on a key reusing chain, so that the same ring may be reused to avoid privacy issues.</source>
        <translation>Isso registra os anéis usados pelo Koson em um blockchain que reutiliza as mesmas chaves. Dessa maneira o mesmo anel pode ser reutilizado evitando problemas de privacidade.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>I intend to spend on key-reusing fork(s)</source>
        <translation>Eu pretendo usar um fork que reutiliza as chaves do Koson</translation>
    </message>
    <message>
        <location filename="../pages/SharedRingDB.qml" line="396"/>
        <source>I might want to spend on key-reusing fork(s)</source>
        <translation>Talvez eu queria usar um fork que reutiliza as chaves do Koson</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Iniciar o blockchain do Koson?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Modo de conservação de espaço no disco utiliza menos espaço, porém a mesma quantidade de banda que o modo normal. Armazenar o blockchain completo ajuda a proteger a rede do Koson. Caso esteja em um dispositivo com espaço em disco limitado, esta opção é para você.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>A mineração protege a rede do Koson e recompensa o minerador com uma pequena quantidade de Koson pelo trabalho feito. Esta opção fará com que seu computador seja utilizado para minerar Koson quando estiver ocioso. A mineração será interrompida quando você voltar a utilizar o computador.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Para se comunicar com a rede Koson, sua carteira precisa estar conectada com um nó Koson. Para maior privacidade, é recomendado que você rode seu próprio nó.                         &lt;br&gt;&lt;br&gt;                         Se você não tem a opção de rodar seu próprio nó, existe a opção de conectar-se a um nó remoto.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">O desenvolvimento do Koson é suportado através de doações</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Para cada transação uma pequena taxa é coletada. Esta opção permite você adicionar uma quantidade adicional (porcentagem desta taxa) para ajudar o desenvolvimento do Koson. Por exemplo, 50% de auto-doação em uma taxa de transferência de 0.005 XMR adicionará 0.0025 XMR na taxa para ajudar o desenvolvimento do projeto.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Mining secures the Koson network, and also pays a small reward for the work done. This option will let Koson mine when your computer is on mains power and is idle. It will stop mining when you continue working.</source>
        <translation>A mineração protege a rede do Koson e recompensa o minerador com uma pequena quantidade de KSN pelo trabalho feito. Esta opção fará com que seu computador seja utilizado para minerar Koson quando estive ocioso. A mineração será interrompida quando você voltar a utilizar o computador.</translation>
    </message>
</context>
<context>
...
Índice do endereço de envio: </translation>
    ...
    <message>
        ...
        <translation>KSN enviado com sucesso: %1 transação(ões) </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Nova versão da carteira (GUI) do Koson disponível: %1&lt;br&gt;%2</translation>
    </message>
    <message>
